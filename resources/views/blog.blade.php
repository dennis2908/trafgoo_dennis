			   			...
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1 class="heading-section">Blog &amp; Events</h1>
									<h2>Brought to you by <a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=#" target="_blank">Tr#afgoo.Edu</a></h2>
			   				</div>
			   			</div>
			   		</div>
		   		</div>
			...
			<div class="row row-padded-mb">
				...
				<div class="col-md-4 animate-box">
					<div class="fh5co-event">
						...
						<h3><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/2Hqpm9M">2021 OECD Internship Programme In Paris-France For Young Students</a></h3>
						...
						<p><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/2Hqpm9M">Read More</a></p>
					</div>
				</div>
				<div class="col-md-4 animate-box">
					<div class="fh5co-event">
						<div class="date text-center"><span>20<br>Nov.</span></div>
						<h3><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/3pozrp9">2020 Internship at Interswitch Group for Nigerian Graduates</a></h3>
						<p>Category: Graduates | All Courses | Max Age 27yrs<br>Deadline: November 20, 2020</p>
						<p><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/3pozrp9">Read More</a></p>
					</div>
				</div>
				<div class="col-md-4 animate-box">
					<div class="fh5co-event">
						<div class="date text-center"><span>20<br>Nov.</span></div>
						<h3><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://www.intelregion.com/scholarships/2020-shell-livewire-programme-for-young-nigerians/">2020 Shell LiveWIRE Programme For Young Nigerians</a></h3>
						...
						<p><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://www.intelregion.com/scholarships/2020-shell-livewire-programme-for-young-nigerians/">Read More</a></p>
					</div>
				</div>
				<div class="col-md-4 animate-box">
					<div class="fh5co-event">
						<div class="date text-center"><span>20<br>Nov.</span></div>
						<h3><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/3l9j8tC">2020 Startup North-East Virtual Incubation Program For Nigerian</a></h3>
						<p>Startups ($3,000 Free funding Prize)<br>Duration: 4-month <br>Benefits:<br>
 • Grant<br>
 • Business Advisory<br>
 • Partnerships<br>
Deadline: December 2, 2021</p>
						<p><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/3l9j8tC">Read More</a></p>
					</div>
				</div>
				...
				<div class="col-md-4 animate-box">
					<div class="fh5co-event">
						<div class="date text-center"><span>20<br>Nov.</span></div>
						<h3><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/2Ih1Cp5">2021 Africa Union AfCFTA Innovation Challenge For Young Africans</a></h3>
...
Deadline: November 23, 2020</p>
						<p><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/2Ih1Cp5">Read More</a></p>
					</div>
				</div>
				...
				<div class="col-md-4 animate-box">
					<div class="fh5co-event">
						<div class="date text-center"><span>20<br>Nov.</span></div>
						<h3><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://www.intelregion.com/scholarships/2021-united-states-international-university-africa-usiu-africa-mastercard-foundation-scholarship/">2021 United States International University-Africa (USIU-Africa) MasterCard Foundation Scholarship</a></h3>
...
Deadline: November 27, 2020</p>
						<p><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://www.intelregion.com/scholarships/2021-united-states-international-university-africa-usiu-africa-mastercard-foundation-scholarship/">Read More</a></p>
					</div>
				...
				<div class="col-md-4 animate-box">
					<div class="fh5co-event">
						<div class="date text-center"><span>20<br>Nov.</span></div>
						<h3><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/3mSyrrf">2020 NITDA Special Intervention Training for Graduates Unemployed Nigerian Youths</a></h3>
...
Deadline: N/A<br></p>
						<p><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/3mSyrrf">Read More</a></p>
					</div>
				</div>
...
<div class="col-md-4 animate-box">
					<div class="fh5co-event">
						<div class="date text-center"><span>20<br>Nov.</span></div>
						<h3><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://www.intelregion.com/scholarships/2020-master-card-foundation-transforming-nigerian-youths-program-for-young-nigerians/">2020 Master Card Foundation Transforming Nigerian Youths Program For Young Nigerians</a></h3>						
...
*Eligibility:* Be a Nigerian</p>
						<p><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://www.intelregion.com/scholarships/2020-master-card-foundation-transforming-nigerian-youths-program-for-young-nigerians/">Read More</a></p>
					</div>
					...
					<div class="fh5co-event">
						<div class="date text-center"><span>20<br>Nov.</span></div>
						<h3><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/3eItdvt">2021 Commonwealth Early Career Researcher Training Grants For African Researchers</a></h3>
...
Deadline: November 23, 2020.
						...
						<p><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/3eItdvt">Read More</a></p>
					</div>
				</div>
				...
				<div class="col-md-4 animate-box">
					<div class="fh5co-event">
						...
						<h3><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/2FSYX3S">2020 World Bank Blog4Dev Essay Competition For Young Africans (Chance to Intern at World Bank)</a></h3>
...
Deadline: November 30, 2020</p>
						<p><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/2FSYX3S">Read More</a></p>
					</div>
				</div>
				...
				<div class="col-md-4 animate-box">
					<div class="fh5co-event">
						<div class="date text-center"><span>20<br>Nov.</span></div>
						<h3><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/2JFkSNv">2021 Fully Funded Doha Institute for Graduate Studies Scholarships in Qatar</a></h3>
						<p>
...
Deadline: February 15, 2021</p>
						<p><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/2JFkSNv">Read More</a></p>
					</div>
				</div>
				<div class="col-md-4 animate-box">
					<div class="fh5co-event">
						<div class="date text-center"><span>20<br>Nov.</span></div>
						<h3><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/3jTLozh">2021 Cisco Global Problem Solver Challenge For Entrepreneurs ($1 Million USD Cash Prize)</a></h3>
...
Deadline: January 29, 2021<br></p>
						<p><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=https://bit.ly/3jTLozh">Read More</a></p>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=#" class="blog-img-holder" style="background-image: url(images/QWER.jpg);"></a>
						<div class="blog-text">
							<h3><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=#">Register And Stand A Chance to Win Prizes</a></h3>
							<span class="posted_on">November. 20th</span>
							<span class="comment"><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=">211<i class="icon-speech-bubble"></i></a></span>
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=#" class="blog-img-holder" style="background-image: url(images/WEBE.jpg);"></a>
						<div class="blog-text">
							<h3><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=#">Earning Graph</a></h3>
							<span class="posted_on">November. 20th</span>
							<span class="comment"><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=">342<i class="icon-speech-bubble"></i></a></span>
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=#" class="blog-img-holder" style="background-image: url(images/payincrease.jpg);"></a>
						<div class="blog-text">
							<h3><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=#">Payment Card</a></h3>
							<span class="posted_on">November. 20th</span>
							<span class="comment"><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=">561<i class="icon-speech-bubble"></i></a></span>
