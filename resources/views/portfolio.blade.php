                  ...
                  <div class="modal-portfolio-detail">
                    ...
                    <div class="col-md-4">
                      <aside class="sidebar">
                        ...
                        <a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=#" class="btn btn-lg btn-block btn-apecsa-red">
                  ...
                  <div class="modal-portfolio-detail">
                    ...
                    <div class="col-md-4">
                      <aside class="sidebar">
                        ...
                        <a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=http://rkpd.tasikmalayakota.go.id/" target="_blank" class="btn btn-lg btn-block btn-apecsa-red">
                          <i class="fa fa-link"></i>
                          Link website
                        </a>
                      </aside>
                  ...
                  <div class="modal-portfolio-detail">
                    ...
                    <div class="col-md-4">
                      <aside class="sidebar">
                        ...
                        <a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=http://plasadana.com/" target="_blank" class="btn btn-lg btn-block btn-apecsa-red">
                          <i class="fa fa-link"></i>
                          Link website
                        </a>
                      </aside>
          ...
          <div class="col-md-12">
            <div class="text-center">
              <nav aria-label="Page navigation">
                <ul class="pagination">
                  <li>
                    <a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=#" aria-label="Previous">
                      <span aria-hidden="true">&laquo;</span>
                    </a>
                  </li>
                  <li class="active"><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=#">1</a></li>
                  <li><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=#">2</a></li>
                  <li><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=#">3</a></li>
                  <li><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=#">4</a></li>
                  <li><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=#">5</a></li>
                  <li>
                    <a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=#" aria-label="Next">
