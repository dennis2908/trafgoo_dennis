				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="fh5co-contact-info">
						...
						<ul>
							...
							<li class="phone"><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=tel://1234567920"> +234 708 140 5096</a></li>
							<li class="email"><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=mailto:info@yoursite.com">infotrafgoo@gmail.com</a></li>
							<li class="url"><a href="{{route('goToPage')}}?page={{route('goToPage')}}?page=http://freehtml5.co">Trafgoo.com</a></li>
						</ul>
					</div>
