			...
			<div class="row">
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							<h3><a href="courses.html">Business</a></h3>
				...
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							<h3><a href="courses.html">Health &amp; Psychology</a></h3>
				...
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							<h3><a href="courses.html">Accounting</a></h3>
				...
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							<h3><a href="courses.html">Science &amp; Technology</a></h3>
				...
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							<h3><a href="courses.html">Art &amp; Media</a></h3>
				...
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							<h3><a href="courses.html">Real Estate</a></h3>
				...
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							<h3><a href="courses.html">Language</a></h3>
				...
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							<h3><a href="courses.html">Web &amp; Programming</a></h3>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="affiliatemarketing.html" class="course-img" style="background-image: url(images/affiliatemarketing.jpg);">
						</a>
						<div class="desc">
							<h3><a href="affiliatemarketing.html">Affiliate Marketing (CERT)</a></h3>
							...
							<span><a href="affiliatemarketing.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="amazonkindle.html" class="course-img" style="background-image: url(images/amazonkindle.jpg);">
						</a>
						<div class="desc">
							<h3><a href="amazonkindle.html">Amazon Kindle Publishing (CERT)</a></h3>
							...
							<span><a href="amazonkindle.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="2Dadobeanimation.html" class="course-img" style="background-image: url(images/2danimation.jpg);">
						</a>
						<div class="desc">
							<h3><a href="2Dadobeanimation.html">2D Adobe Animate (CERT)</a></h3>
							...
							<span><a href="2Dadobeanimation.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="3Dadobeanimation.html" class="course-img" style="background-image: url(images/3danimation.png);">
						</a>
						<div class="desc">
							<h3><a href="3Dadobeanimation.html">3D Adobe Animate (CERT)</a></h3>
							...
							<span><a href="3Dadobeanimation.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="anti-agindspa.html" class="course-img" style="background-image: url(images/Skincare-small.png);">
						</a>
						<div class="desc">
							<h3><a href="anti-agindspa.html">Anti-aging Spa</a></h3>
							...
							<span><a href="anti-agingspa.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="autocad.html" class="course-img" style="background-image: url(images/autocad.png);">
						</a>
						<div class="desc">
							<h3><a href="autocad.html">Auto CAD (CERT)</a></h3>
							...
							<span><a href="autocad.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="baking.html" class="course-img" style="background-image: url(images/baking.jpg);">
						</a>
						<div class="desc">
							<h3><a href="baking.html">Bakery Business</a></h3>
							...
							<span><a href="baking.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="barbing.html" class="course-img" style="background-image: url(images/barbing.jpg);">
						</a>
						<div class="desc">
							<h3><a href="barbing.html">Barbing</a></h3>
							...
							<span><a href="barbing.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="blogging.html" class="course-img" style="background-image: url(images/blogging.jpg);">
						</a>
						<div class="desc">
							<h3><a href="blogging.html">Blogging </a></h3>
							...
							<span><a href="blogging.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="computerhardware.html" class="course-img" style="background-image: url(images/computerhardware.png);">
						</a>
						<div class="desc">
							<h3><a href="computerhardware.html">Computer Hardware (CERT)</a></h3>
							...
							<span><a href="computerhardware.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="chinese.html" class="course-img" style="background-image: url(images/chinese.png);">
						</a>
						<div class="desc">
							<h3><a href="chinese.html">Chinese Language (CERT)</a></h3>
							...
							<span><a href="chinese.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="css.html" class="course-img" style="background-image: url(images/CSS.png);">
						</a>
						<div class="desc">
							<h3><a href="css.html">Computer Hardware (CERT)</a></h3>
							<p>Computer Hardware & Certification. Get certified today at Trafgoo.Edu. <br>In these course you will learn how to design, create and test computer hardware equipment, as well as researching and developing new technologies</p>
							<span><a href="css.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="coreldraw.html" class="course-img" style="background-image: url(images/coreldraw.jpg);">
						</a>
						<div class="desc">
							<h3><a href="coreldraw.html">CorelDRAW (CERT)</a></h3>
							<p>CorelDRAW & Certification. Get certified today at Trafgoo.Edu. <br>Learn how to use CorelDRAW design software to create vector art and illustrations for logos, web graphics, brochure and more.</p>
							<span><a href="coreldraw.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="customclothing.html" class="course-img" style="background-image: url(images/customclothing.jpeg);">
						</a>
						<div class="desc">
							<h3><a href="customclothing.html">Custom Clothing</a></h3>
							...
							<span><a href="customclothing.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="dropshipping.html" class="course-img" style="background-image: url(images/dropshipping.jpg);">
						</a>
						<div class="desc">
							<h3><a href="dropshipping.html">Drop Shipping</a></h3>
							...
							<span><a href="dropshipping.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="fitnessinstructor.html" class="course-img" style="background-image: url(images/fitness.jpg);">
						</a>
						<div class="desc">
							<h3><a href="fitnessinstructor.html">Fitness Instructor (CERT)</a></h3>
							...
							<span><a href="fitnessinstructor.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="forex.html" class="course-img" style="background-image: url(images/forex.png);">
						</a>
						<div class="desc">
							<h3><a href="forex.html">Forex (CERT)</a></h3>
							...
							<span><a href="forex.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="html.html" class="course-img" style="background-image: url(images/html.png);">
						</a>
						<div class="desc">
							...
							<span><a href="html.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="interiordecor.html" class="course-img" style="background-image: url(images/interiordecor.jpg);">
						</a>
						<div class="desc">
							<h3><a href="interiordecor.html">Interior Decor (CERT)</a></h3>
							...
							<span><a href="interiordecor.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span> 
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="makeup.html" class="course-img" style="background-image: url(images/makeup.jpg);">
						</a>
						<div class="desc">
							<h3><a href="makeup.html">Makeup Business</a></h3><br>
							...
							<span><a href="makeup.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="mathstut1.html" class="course-img" style="background-image: url(images/maths1.jpg);">
						</a>
						<div class="desc">
							<h3><a href="mathstut1.html">MATH-TUT (A)</a></h3>
							...
							<span><a href="mathstut1.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="mathstut2.html" class="course-img" style="background-image: url(images/maths2.jpg);">
						</a>
						<div class="desc">
							<h3><a href="mathstut2.html">MATHS-TUT (B)</a></h3>
							...
							<span><a href="mathstut2.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="mathstut3.html" class="course-img" style="background-image: url(images/maths3.jpg);">
						</a>
						<div class="desc">
							<h3><a href="mathstut3.html">MATHS-TUT (C)</a></h3>
							...
							<span><a href="mathstut3.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="officemanagement.html" class="course-img" style="background-image: url(images/officskill.jpg);">
						</a>
						<div class="desc">
							<h3><a href="officemanagement.html">Office Management (CERT)</a></h3>
							...
							<span><a href="officemanagement.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="photoshop.html" class="course-img" style="background-image: url(images/photoshop.png);">
						</a>
						<div class="desc">
							<h3><a href="photoshop.html">Photoshop (CERT)</a></h3>
							...
							<span><a href="photoshop.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="photographer.html" class="course-img" style="background-image: url(images/photographer.jpg);">
						</a>
						<div class="desc">
							<h3><a href="photographer.html">Professional Photographer (CERT)</a></h3>
							...
							<span><a href="photographer.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="productionperfume.html" class="course-img" style="background-image: url(images/prodetergent.jpg);">
						</a>
						<div class="desc">
							<h3><a href="productionperfume.html">Production of Detergents/Perfumes</a></h3>
							...
							<span><a href="productionperfume.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="shoemanufacturing.html" class="course-img" style="background-image: url(images/shoe.jpg);">
						</a>
						<div class="desc">
							<h3><a href="shoemanufacturing.html">Shoe manufacturing (CERT)</a></h3><br>
							...
							<span><a href="shoemanufacturing.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="solarenergy.html" class="course-img" style="background-image: url(images/Solar-panel.png);">
						</a>
						<div class="desc">
							<h3><a href="solarenergy.html">Solar Energy installation (CERT)</a></h3>
							...
							<span><a href="solarenergy.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="videoediting.html" class="course-img" style="background-image: url(images/videoediting.jpg);">
						</a>
						<div class="desc">
							<h3><a href="videoediting.html">Video Editing Course (CERT)</a></h3>
							...
							<span><a href="videoediting.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="wallpaper.html" class="course-img" style="background-image: url(images/wallpaper.jpg);">
						</a>
						<div class="desc">
							<h3><a href="wallpaper.html">3D Wallpaper/panel</a></h3><br>
							...
							<span><a href="wallpaper.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="youtuber.html" class="course-img" style="background-image: url(images/youtuber.jpg);">
						</a>
						<div class="desc">
							<h3><a href="youtuber.html">YouTuber</a></h3>
							...
							<span><a href="youtuber.html" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
			...
			<div class="row row-padded-mb">
				...
				<div class="col-md-4 animate-box">
					<div class="fh5co-event">
						...
						<h3><a href="https://bit.ly/2Hqpm9M">2021 OECD Internship Programme In Paris-France For Young Students</a></h3>
						...
						<p><a href="https://bit.ly/2Hqpm9M">Read More</a></p>
					</div>
				</div>
				...
				<div class="col-md-4 animate-box">
					<div class="fh5co-event">
						...
						<h3><a href="https://bit.ly/2FSYX3S">2020 World Bank Blog4Dev Essay Competition For Young Africans (Chance to Intern at World Bank)</a></h3>
...
Deadline: November 30, 2020</p>
						<p><a href="https://bit.ly/2FSYX3S">Read More</a></p>
					</div>
				</div>
				...
				<div class="col-md-4 animate-box">
					<div class="fh5co-event">
						...
						<h3><a href="https://bit.ly/3jTLozh">2021 Cisco Global Problem Solver Challenge For Entrepreneurs ($1 Million USD Cash Prize)</a></h3>
...
Deadline: January 29, 2021<br></p>
						<p><a href="https://bit.ly/3jTLozh">Read More</a></p>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="#" class="blog-img-holder" style="background-image: url(images/QWER.jpg);"></a>
						<div class="blog-text">
							<h3><a href="#">Register And Stand A Chance to Win Prizes</a></h3>
							<span class="posted_on">November. 20th</span>
							<span class="comment"><a href="">211<i class="icon-speech-bubble"></i></a></span>
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="#" class="blog-img-holder" style="background-image: url(images/WEBE.jpg);"></a>
						<div class="blog-text">
							<h3><a href="#">Earning Graph</a></h3>
							<span class="posted_on">November. 20th</span>
							<span class="comment"><a href="">342<i class="icon-speech-bubble"></i></a></span>
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="#" class="blog-img-holder" style="background-image: url(images/payincrease.jpg);"></a>
						<div class="blog-text">
							<h3><a href="#">Payment Card</a></h3>
							<span class="posted_on">November. 20th</span>
							<span class="comment"><a href="">561<i class="icon-speech-bubble"></i></a></span>
