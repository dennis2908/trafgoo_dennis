...
<html>
	...
	<aside id="fh5co-hero">
		<div class="flexslider">
			<ul class="slides">
		   	<li style="background-image: url(images/ebooktut.jpg);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1 class="heading-section">Trafgoo Books</h1>
...
.title h1{
    ...
    <div class="title">
           ...
           <div class="iteams"  id="puran">
              <div class="card" style="width: 11rem; height:13rem; margin:4px;float:auto;margin-left:5px"  class="bg-dark" > 
     ...
     <aside>    <div class="iteams"  id="puran">
              <div class="card" style="width: 11rem; height:13rem; margin:4px;float:auto; margin-left:5px; " class="bg-dark" > 
...
<div class="title">
     ...
     <aside>    <div class="iteams"  id="puran">
          ...
          <div class="title">
           ...
           <div class="iteams"  id="puran">
              <div class="card" style="width: 11rem; height:14rem;  margin:4px;"  class="bg-dark" > 
     ...
     <aside>   <div class="iteams"  id="puran">
           ...
           <div class="iteams"  id="puran">
            ...
            <div class="iteams"  id="puran">
              <div class="card" style="width: 11rem; height:14rem; margin:4px; margin-left:5px; " class="bg-dark" > 
